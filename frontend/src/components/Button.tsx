...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    primary: 'bg-primary-600 text-white hover:bg-primary-700 focus:ring-primary-500 shadow-sm hover:shadow-md active:scale-95 hover:shadow-glow-primary',
    ...
    outline: 'border-2 border-primary-500 text-primary-400 hover:bg-primary-950 focus:ring-primary-500 active:scale-95',
    ghost: 'text-dark-text hover:bg-dark-card focus:ring-primary-500 active:scale-95',
